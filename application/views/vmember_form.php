        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="<?= base_url() ?>cmember">Data Member</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                        ...
                        <form action="<?= base_url() ?>cmember/form/<?= $act ?>/<?= $member_id ?>" method="post" id="form_sample_1" class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="kode_member" data-required="1" placeholder="Kode member..." value="<?= $kode_member ?>" class="form-control input-height" /> </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="nama" data-required="1" placeholder="Masukkan nama..." value="<?= $nama ?>" class="form-control input-height" /> </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <textarea name="alamat" placeholder="Alamat" class="form-control-textarea" rows="5"><?= $alamat ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="no_identitas" data-required="1" placeholder="No hp" value="<?= $no_identitas ?>" class="form-control input-height" /> </div>
                                </div>
