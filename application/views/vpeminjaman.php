		...
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				...
				<ol class="breadcrumb page-breadcrumb pull-right">
					...
					<li><a class="parent-item" href="index.php?page=penghuni">Data Peminjaman</a>&nbsp;<i
							class="fa fa-angle-right"></i>
					</li>
			...
			<div class="col-md-12">
									...
									<div class="card-body ">
										<div class="row">
											<div class="col-md-6 col-sm-6 col-xs-6">
												<div class="btn-group">
													<a href="<?=base_url()?>cpeminjaman/form/add" id="addRow"
														class="btn btn-info">
                ...
                $num++; ?>
													<tr>
														...
														<td>
															<i class="fa fa-book"></i> <?=$rowpeminjaman->judul?>
														</td>
														...
														<td>
															<div class="btn-group">
																<a href="<?=base_url()?>cpeminjaman/form/upd/<?=$rowpeminjaman->peminjaman_id?>"
																	class="btn btn-primary" role="button">
																	<span class="fa fa-pencil"></span></a>
																<a href="<?=base_url()?>cpeminjaman/del/<?=$rowpeminjaman->peminjaman_id?>"
																	class="btn btn-danger ml-2"
																	onclick="return confirm('Delete peminjam <?=$rowpeminjaman->nama?>')"
																	role="button">
