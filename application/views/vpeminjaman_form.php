						...
						<form action="<?= base_url() ?>cpeminjaman/form/<?= $act ?>/<?= $peminjaman_id ?>" method="post" id="form_sample_1" class="form-horizontal">
							<div class="form-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-5">
										<input type="text" name="jumlah_pinjam" data-required="1" placeholder="5" value="<?= $jumlah_pinjam ?>" class="form-control input-height" /> </div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-5">
										<input type="text" name="ket_pinjam" data-required="1" placeholder="Keterangan..." value="<?= $ket_pinjam ?>" class="form-control input-height" /> </div>
								</div>

								<div class="form-actions">
									<div class="row">
										<div class="offset-md-3 col-md-9">
											<button name="submit" type="submit" id="btnSave" class="btn btn-success m-r-20"><i class="fa fa-save"></i>
